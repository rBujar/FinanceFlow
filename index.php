...
<body>
  ...
  <div class="rewards-bg">
    <section class="rewards container">
      <div class="row">
        <div class="rewards__card col-12">
          <div class="row">
            <div class="rewards__image rewards__image--top col-8 offset-2 col-lg-5 offset-lg-0">
              <img src="./src/assets/rewards-phones.png" alt="rewards phone">
            </div>
            <div class="rewards__content col-12 col-lg-5 offset-lg-2 col-xl-4 offset-xl-3">
        ...
        <div class="rewards__card col-12">
          <div class="row">
            <div class="rewards__content col-12 col-lg-5 col-xl-4">
              <h2>Earn daily rewards on your idle tokens</h2>
              <p class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat nulla suspendisse
                tortor aene.</p>
              <div class="rewards__features">
            ...
            <div class="rewards__image rewards__image--bottom col-12 col-lg-7 col-xl-8">
              <img src="./src/assets/rewards-laptop.png" alt="rewards phone">
            </div>
          </div>
        </div>
      </div>
