    ...
    <div class="error-bg bg-secondary-bg">
      <section class="error container mx-auto px-4 text-primary-white py-[100px] lg:py-[120px] xl:py-[150px]">
        <div class="grid grid-cols-12">
          <div class="error__title col-span-8 col-start-3 lg:col-span-6 lg:col-start-4 flex flex-col justify-center items-center" data-aos="fade" data-aos-delay="100">
          ...
          <div class="error__buttons col-span-12 flex flex-col justify-center items-center gap-4 lg:flex-row lg:gap-6" data-aos="fade" data-aos-delay="150">
