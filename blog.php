    ...
    <section class="blog container">
      <div class="row">
        <div class="blog__title col-12">
          <h2>Blog</h2>
          <p class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat nulla suspendisse tortor
        ...
        <div class="blog__content col-12">
          <div class="blog__item">
            ...
            <div class="blog__info">
              <div class="blog__articleType">
                <p class="text-caps">PRODUCTS</p>
              </div>
              <div class="blog__infoTitle">
                <h4 class="text-lg text-bold">The Basics about Cryptocurrency</h4>
                <p class="text-sm">Lorem ipsum dolor sit ametero irseo, consectetur adipiscing elit. Scelerisque viverra
                  donec diammeo.</p>
              </div>
